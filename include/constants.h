...
#ifndef CARTESIAN_GENETIC_PROGRAMMING_CPP_INCLUDE_CONSTANTS_H_
#define CARTESIAN_GENETIC_PROGRAMMING_CPP_INCLUDE_CONSTANTS_H_
...
#endif  // CARTESIAN_GENETIC_PROGRAMMING_CPP_INCLUDE_CONSTANTS_H_
