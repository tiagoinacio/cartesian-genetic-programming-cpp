...
#ifndef WORK_GITHUB_CGP_TOOLBOX_C___SRC_SHARED_CONSTANTS_H_
#define WORK_GITHUB_CGP_TOOLBOX_C___SRC_SHARED_CONSTANTS_H_
...
#endif  // WORK_GITHUB_CGP_TOOLBOX_C___SRC_SHARED_CONSTANTS_H_
